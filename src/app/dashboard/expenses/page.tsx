  ...
  return (
    <>
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">Registro detallado de todos tus gastos</p>
      </div>
      ...
      <Card className="mb-8">
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground mb-1">Total de gastos mostrados</p>
              <h2 className="text-4xl font-bold text-primary">{formatSoles(totalExpenses)}</h2>
            </div>
